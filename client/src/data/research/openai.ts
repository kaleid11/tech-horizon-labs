...
export const openaiData: CompanyData = {
  ...
  fundingRounds: [
    ...
    { date: "Feb 2026", label: "Mega Round", total: 110000, val: 730000, lead: "Amazon / SoftBank / Nvidia", inv: [{ n: "Amazon", a: 50000, note: "Largest single investor check in private market history" }, { n: "SoftBank", a: 30000, note: "Cash equity, phased tranches" }, { n: "Nvidia", a: 30000, note: "Primarily GPU compute credits, not cash" }], events: ["Largest private round EVER", "$730B pre-money ($840B post)", "Round remains open — additional investors expected", "Total raised: ~$168B"] },
  ],
};
