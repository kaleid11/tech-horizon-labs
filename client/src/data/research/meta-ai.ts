...
export const metaAIData: CompanyData = {
  ...
  fundingRounds: [
    { date: "2023", label: "AI CapEx", total: 15000, val: 950000, lead: "Meta Internal", inv: [{ n: "Meta Internal", a: 15000, note: "AI R&D and infrastructure spend — not an external investment. No standalone Meta AI valuation exists. This chart tracks Meta Platforms' public market capitalisation (NASDAQ: META) as a proxy for the AI division's scale. Meta AI has no independent legal entity, no external shareholders, and no externally verified valuation." }], events: ["LLaMA 2 release drives open-source AI", "Meta stock +194% (2023)", "Meta market cap ~$950B"], external: false },
