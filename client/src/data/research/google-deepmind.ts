...
export const googleDeepMindData: CompanyData = {
  meta: {
    ...
    lastUpdated: "Mar 2026", keyModel: "Gemini 3.1 Pro", openSource: "No", founded: "2010", hq: "London / SF",
  },
  tabs: [
  ...
  fundingRounds: [
    { date: "Jan 2014", label: "Acquisition", total: 500, val: 500, lead: "Google (Alphabet)", inv: [{ n: "Google", a: 500, note: "Acquisition price ~$500M (reported by multiple outlets including Bloomberg Jan 2014). Google refused to confirm the exact amount publicly. No post-acquisition standalone valuation for Google DeepMind exists or has been disclosed." }], events: ["DeepMind acquired by Google", "Largest AI acquisition of the era"] },
    { date: "2023", label: "AI CapEx", total: 32000, val: 1700000, lead: "Alphabet Internal", inv: [{ n: "Alphabet", a: 32000, note: "Alphabet total AI R&D and infrastructure capex — not an external investment. No standalone Google DeepMind valuation exists. Google DeepMind is a wholly-owned research division of Alphabet (NASDAQ: GOOGL). This chart tracks Alphabet's public market capitalisation as a proxy for scale only. Source: Alphabet Q4 2023 earnings." }], events: ["Google Cloud AI revenue $33B", "Custom TPU v5 chips", "$300M invested in Anthropic", "Alphabet market cap ~$1.7T (Alphabet earnings)"], external: false },
    { date: "2024", label: "AI CapEx", total: 50000, val: 2100000, lead: "Alphabet Internal", inv: [{ n: "Alphabet", a: 50000, note: "Alphabet AI capex. Not an external investment. No independent Google DeepMind valuation exists. As a 100%-owned division, it has no external shareholders, no funding rounds, and no externally verified standalone value. Source: Alphabet Q4 2024 earnings call." }], events: ["Google Cloud AI revenue $43B", "Gemini 2.0 launched", "Nobel Prize for AlphaFold", "Alphabet market cap ~$2.1T (Alphabet Q4 2024 earnings)"], external: false },
    { date: "2025", label: "AI CapEx", total: 75000, val: 2300000, lead: "Alphabet Internal", inv: [{ n: "Alphabet", a: 75000, note: "Alphabet 2025 capex guidance. Not an external investment. $75B guidance issued Feb 2025 (Alphabet Q4 2024 earnings call). No independent DeepMind division valuation has been disclosed or externally verified. Market cap used as parent-scale proxy only." }], events: ["$75B AI infrastructure commitment (Alphabet guidance, Feb 2025)", "Gemini 3.0 in development", "2,000+ DeepMind researchers across London and SF", "Alphabet market cap ~$2.3T (Mar 2026)"], external: false },
  ],
  financials: [
