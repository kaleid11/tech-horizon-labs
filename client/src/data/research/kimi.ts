...
export const kimiData: CompanyData = {
  ...
  fundingRounds: [
    ...
    { date: "Feb 2026", label: "Series D", total: 700, val: null, lead: "Alibaba / Tencent / 5Y Capital", inv: [{ n: "Alibaba", a: 250, note: "Reported — not officially confirmed." }, { n: "Tencent", a: 200, note: "Reported — not officially confirmed." }, { n: "5Y Capital", a: 150, note: "Reported — not officially confirmed." }, { n: "Other", a: 100, note: "Reported — not officially confirmed." }], events: ["Fundraising ongoing — targeting $10-12B valuation", "Cash reserves >$1.4B", "Reported: $700M+ first tranche in discussion"] },
  ],
};
