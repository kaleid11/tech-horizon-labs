...
export const kimiData: CompanyData = {
  ...
  fundingRounds: [
    ...
    { date: "Feb 2026", label: "Series D (T1)", total: 700, val: 10000, lead: "Alibaba / Tencent / 5Y Capital", inv: [{ n: "Alibaba", a: 250, note: "Reported — existing backer committing first tranche." }, { n: "Tencent", a: 200, note: "Reported — existing backer committing first tranche." }, { n: "5Y Capital", a: 150, note: "Reported — early backer since seed." }, { n: "Other", a: 100, note: "Reported — total first tranche $700M+." }], events: ["Reported: first tranche closed at $10B valuation", "Fastest Chinese AI co to decacorn status per Bloomberg Feb 2026", "Cash reserves >$1.4B", "Reported: Series D expansion targeting $18B under discussion (Mar 2026)"] },
  ],
};
