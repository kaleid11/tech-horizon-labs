...
export const qwenData: CompanyData = {
  ...
  controversies: [
    { date: "Ongoing", title: "CCP Content Filtering at Model Level", sev: "critical", desc: "Qwen models apply hardcoded censorship filters for topics sensitive to the Chinese Communist Party: Taiwan independence, Tiananmen Square events, Xinjiang documentation, and criticism of Xi Jinping. Researchers have demonstrated these filters are embedded at the model weights level — not just applied at the API layer — meaning they persist in open-weight releases. This raises a fundamental question about what 'open source' means for a CCP-adjacent model: you can inspect and deploy the weights, but the political restrictions travel with them. Western enterprises using Qwen's open weights for on-premise deployment carry these censorship characteristics into their own systems." },
    { date: "2024-2025", title: "Training Data Provenance & Model Distillation", sev: "warn", desc: "Like DeepSeek, Qwen has faced scrutiny over whether training data includes outputs distilled from GPT-4, Claude, and other Western models — potentially violating those models' terms of service. Several researchers have published reports showing Qwen models reproducing characteristic GPT-4 error patterns and phrasings not present in public datasets, suggesting some distillation. Alibaba has not published detailed data composition reports, and the models' technical papers describe data sources only at a high level. The broader issue: at frontier scale, virtually all Chinese labs face this question, since high-quality English instruction-following data largely originates from US model outputs." },
    { date: "Ongoing", title: "Alibaba's Regulatory Relationship with the CCP", sev: "warn", desc: "Alibaba operates under Chinese national security laws — specifically Articles 7 and 14 of China's 2017 National Intelligence Law — that require cooperation with government intelligence requests without the ability to disclose such requests to users or counterparties. The 2020-2021 regulatory crackdown demonstrated the CCP's direct control: Jack Ma's Ant Group IPO was blocked days before listing, Alibaba received a $2.8B antitrust fine, and Ma disappeared from public life for months. Qwen model training data, API usage logs, user interaction data, and model weights are all held by an entity subject to these laws. Alibaba cannot legally disclose if the government has requested access." },
    { date: "2025", title: "Enterprise Adoption Blocked in Western Markets", sev: "info", desc: "Following the DeepSeek ban precedent, several Western enterprise security teams and government agencies have added Qwen API endpoints to their blocked services lists. Data sovereignty concerns — particularly around where training data originates and where inference logs are stored — are the primary driver. The open-weight strategy partially mitigates this for security-conscious users (models can run fully on-premise on enterprise hardware, with no data leaving the network), but organisations without GPU infrastructure to run 72B+ parameter models have no sovereign alternative." },
    { date: "Feb 2025", title: "The $53B Infrastructure Pledge: Signal vs Substance", sev: "info", desc: "Alibaba's February 2025 announcement of $53B in AI and cloud infrastructure over three years was immediately reported as the largest AI infrastructure commitment by a Chinese company. Analysts later noted the figure includes existing cloud infrastructure renewal cycles, planned data centre expansions already in the capital budget, and replacement of ageing hardware — not solely net-new AI-specific investment. The announcement closely followed DeepSeek's January 2025 market impact and served simultaneously as competitive positioning, political signalling to the Chinese government of AI leadership commitment, and investor messaging. The real net-new AI-specific spend is likely materially lower." },
  ],
};
