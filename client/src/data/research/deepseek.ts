...
export const deepseekData: CompanyData = {
  ...
  timeline: [
    ...
    { date: "Late 2025", title: "DeepSeek R2 Development Reported", sev: "info", desc: "Multiple technical sources report DeepSeek is training its next major model, expected to be called DeepSeek-R2 or V4. No official announcement made. Reports suggest significantly larger scale than V3 (671B params) with expanded multimodal capabilities. DeepSeek's pattern of silent development followed by surprise releases makes timeline predictions unreliable." },
  ],
  fundingRounds: [
