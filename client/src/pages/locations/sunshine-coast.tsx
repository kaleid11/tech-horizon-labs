      ...
      <main>
        <section className="relative pt-32 pb-20 bg-gradient-to-br from-aubergine-900 via-aubergine-800 to-aubergine-900 text-white overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <ContactFormDialog>
                <Button data-testid="button-sc-book-discovery" size="lg" className="bg-salmon-500 hover:bg-salmon-600 text-aubergine-900 font-bold rounded-full px-8">
        ...
        <section className="py-20 bg-aubergine-900 text-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <ContactFormDialog>
              <Button data-testid="button-sc-cta-book" size="lg" className="bg-salmon-500 hover:bg-salmon-600 text-aubergine-900 font-bold rounded-full px-8">
                Book Free Discovery Call
              </Button>
            </ContactFormDialog>
